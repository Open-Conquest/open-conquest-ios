...
//
//        // setup ore
////        uiOre.backgroundColor = UIColor.black
////        uiOre.alpha = 0.4
...
//
//        let uiOreBackground = UIView()
//        uiOreBackground.backgroundColor = .black
//        uiOreBackground.alpha = 0.4
//        uiOre.addSubview(uiOreBackground)
//        uiOreBackground.autoPinEdge(.top, to: .top, of: uiOre)
//        uiOreBackground.autoPinEdge(.bottom, to: .bottom, of: uiOre)
//        uiOreBackground.autoPinEdge(.left, to: .left, of: uiOre)
//        uiOreBackground.autoPinEdge(.right, to: .right, of: uiOre)
//
...
//        uiOreLabel.textColor = UIColor.white
