...
//
//    var uiKingdomButton: UIButton = UIButton()
//
//    // spritekit elements
//    // tile elements
...
//           uiNavbar.image = UIImage(named: "topbar")
...
//           view.addSubview(uiGold)
//           uiGold.autoPinEdge(.bottom, to: .bottom, of: uiNavbar, withOffset: resourceBackgroundNavbarOffset)
//           uiGold.autoPinEdge(.left, to: .left, of: view, withOffset: widthOffset)
//
//           let uiGoldIcon = UIImageView()
//           uiGoldIcon.image = UIImage(named: "gold_1")
...
//           uiWoodIcon.image = UIImage(named: "wood_1")
...
//           uiStoneIcon.image = UIImage(named: "stone_1")
...
//           uiOreIcon.image = UIImage(named: "ore_1")
...
//
//           // setup kingdom button
//           let uiKingdomButtonHeight = screenSize.width/6
//           let uiKingdomButtonWidth = uiKingdomButtonHeight
//           let uiKingdombuttonImage = UIImage(named: "crown-button-3")
//           uiKingdomButton.setBackgroundImage(uiKingdombuttonImage, for: UIControlState.normal)
//           uiKingdomButton.autoSetDimension(.width, toSize: uiKingdomButtonHeight)
//           uiKingdomButton.autoSetDimension(.height, toSize: uiKingdomButtonWidth)
//           view.addSubview(uiKingdomButton)
//           uiKingdomButton.autoPinEdge(.bottom, to: .bottom, of: view, withOffset: -5)
//           uiKingdomButton.autoPinEdge(.right, to: .right, of: view, withOffset: -5)
//       }
}
